...
uint256 hashGenesisBlock("0x83d1069549cce128f699df38f0f110e91b3ad6aa72f25cb4ebecb409c230a090");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 40); // starting difficulty is 1 / 2^12
...
const string strMessageMagic = "UfmCoin Signed Message:\n";
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal ufmcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "UfmCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x26b8df79efd91bf43c165db6e4321a18144e82a0176aafd5318650f897182f93");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "El dia que Juanro le gano a Wicho con beerus";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nNonce   = 2085662904;

        if (fTestNet)
        {
            block.nTime    = 1528138293;
            block.nNonce   = 389420483;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x6a323ed326e3083a6dfdf78836a860e19a634be2c1cca1ffc1f562c9282bfec5"));
